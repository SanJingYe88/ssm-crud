...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-8">
                <button class="btn btn-primary" id="post_add_model_btn">发布新帖</button>
            </div>
        </div>
        <br/>
        <!-- 显示表格数据 -->
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form class="form-horizontal" id="emp_add_form">
	          <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <input type="text" name="postTitle" class="form-control" id="postTitle_add_input" placeholder="帖子标题">
			  ...
			  <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <textarea name="postInfo" class="form-control" id="postInfo_add_input" placeholder="帖子内容"></textarea>
	              <span class="help-block"></span>
	            </div>
	          </div>
	        </form>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" id="post_save_btn">发布</button>
	      </div>
	    </div>
	  </div>
	</div>
    ...
    <script type="text/javascript">
        // 发布新帖
    	$("#post_add_model_btn").click(function(){
    		/*
       		// 先清空表单信息
